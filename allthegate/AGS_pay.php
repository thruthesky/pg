...
<section class="AGS_pay">
    <div>
		...
		<input type="hidden" name="layout" value="no">
            ...
            <input type="hidden" name="OrdAddr" maxlength=100 value="주문자 주소 <?php echo iconv('UTF-8', 'EUC-KR', $payment['UserAddress'])?>"><!--주문자 주소-->
            ...
            <input type="hidden" name="DlvAddr" maxlength=100 value="배송지 주소 <?php echo iconv('UTF-8', 'EUC-KR', $payment['RecvAddress'])?>"><!--배송지 주소-->
