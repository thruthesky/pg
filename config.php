...
$payment['MallUrl']             = home_url();              // 쇼핑몰 홈페이지.
...
// 결제 정보. 관리자 페이지에서 입력하는 값이 들어간다.
$payment['allthegate_id']  = "aegis";                           // 올더게이트 상점 아이디. 테스트 아이디는 "aegis"
$payment['company_name']        = "Withcenter, Inc.";                // 회사 이름 ( 상점 이름 )
$payment['allthegate_item_name']           = "화상영어 수업료";                       // 상품 이름. ( 아이템 이름 )
$payment['UserEmail']           = "thruthesky@gmail.com";                           // 상점 관리자 메일 주소

// 상황에 따라서 변하는 값으로 대충 지정 해 놓고, 수정 할 필요가 없는 값
$payment['SubjectData'] = "$payment[company_name];$payment[allthegate_item_name];100000;2012.09.01 ~ 2012.09.31"; // 제목: 제목은 1컨텐츠당 5자 이내이며, 상점명;상품명;결제금액;제공기간; 순으로 입력해 주셔야 합니다. 입력 예)업체명;판매상품;계산금액;제공기간; 예제 1) 업체명;판매상품;계산금액;2012.09.01 ~ 2012.09.30;
